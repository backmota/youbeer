...
* Fix - Pass number of products variable to get_related for more then 5 Otros Productos
...
= 2.0.8 - 17/04/2013 =
* Feature - Otros Productos shortcode.
...
* Tweak - Exclude up-sells from Otros Productos.
