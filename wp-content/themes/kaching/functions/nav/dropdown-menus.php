...
class DropDown_Menu_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'dropdown-menu-widget', 'description' => __( 'Use this widget to add one of your custom menus as a dropdown.', 'tfbasedetails' ) );
		parent::__construct( 'dropdown_menu', __('Dropdown Menu', 'tfbasedetails'), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		if ( ! $menus ) {
			echo '<p>'. sprintf( __( 'No menus have been created yet. <a href="%s">Create some</a>.', 'tfbasedetails' ), admin_url( 'nav-menus.php' ) ) .'</p>';
			return;
		}
		?>
		<p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'nav_menu' ); ?>"><?php _e( 'Select Menu:', 'tfbasedetails' ); ?></label>
